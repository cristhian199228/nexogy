...
<body>
    ...
    <br>
    <br>
    <h3><strong>CONSTANCIA DE RESULTADOS <br>PRUEBA SEROLÓGICA COVID-19 N° {{ $constancia['id'] }}</strong></h3>
    <div class="contenido">
        ...
        @endif
        <br>
        <p class="segundo_prueba"><strong>PRUEBA SEROLÓGICA (RÁPIDA) SARS COV 2 (COVID-19)</strong></p>
        <br>
        <br>
        @if($constancia['res'])
                ...
                <div class="centered">
                    <table>
                        <tr>
                            ...
                            @endphp
                            <tr>
                                <td style="background-color:<?php echo $igm ?>"></td>
                                <td style="background-color:<?php echo $igg ?>"></td>
                                <td style="background-color:<?php echo $igm_igg ?>"></td>
                            </tr>
                    </table>
                </div>
            @endif
