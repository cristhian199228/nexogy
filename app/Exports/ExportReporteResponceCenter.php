...
class ExportReporteResponceCenter implements FromView, ShouldAutoSize, WithEvents, WithDrawings
{
    private $data;
    ...
    {
        return view('excel.reporte_rc', [
            'evidencias' => $this->data
        ]);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class   => function (AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('B2:M3')->applyFromArray($styleArray);
                ...
                $event->sheet->getDelegate()->getColumnDimension('B')->setWidth("40");//fecha
                $event->sheet->getDelegate()->getColumnDimension('C')->setWidth("30");//estacion
                $event->sheet->getDelegate()->getColumnDimension('D')->setWidth("40");//usuario
                $event->sheet->getDelegate()->getColumnDimension('E')->setWidth("50");//nombres
                ...
                $event->sheet->getDelegate()->getStyle('A1:M3')
